...
const SearchBox = () => {
  ...
  const smellClick = "Color";
  const skinClick = "Quality";
  const fragClick = "Tradition"
  const tonerClick = "Look";
  const hydrClick = "content";
  const faceClick = "stone";
  const mistClick = "feel";
  const glowClick = "glow";
  const boostClick = "Shine"
  ...
  return (
    <div>
      ...
      <div className='keyWordHold w40rem uppercase flex fof flex-wrap gap-11'>
        <p className='keyWord hover:bg-slate-200' onClick={smellHandler}>Color</p>
        <p className='keyWord hover:bg-slate-200' onClick={skinHandler}> Quality </p>
        <p className='keyWord hover:bg-slate-200' onClick={fragClickHandler}> Tradition </p>
        <p className='keyWord hover:bg-slate-200' onClick={tonerHnadler}> Look </p>
        <p className='keyWord hover:bg-slate-200' onClick={hydraHnadler}> content </p>
        <p className='keyWord hover:bg-slate-200' onClick={faceClickHandler}> stone </p>
        <p className='keyWord hover:bg-slate-200' onClick={mistClickHandler}> feel </p>
        <p className='keyWord hover:bg-slate-200' onClick={glowClickHandler}> glow </p>
        <p className='keyWord hover:bg-slate-200' onClick={boostClickHnadler}> Shine </p>
