  ...
  return (
    <div className='singlePageMainParent relative top-36'>
      ...
      <div className='sideImageHold flex flex-col relative gap-12'>
        ...
        <img src='https://img.freepik.com/premium-photo/there-are-many-different-types-jewelry-table-generative-ai_958124-92189.jpg' className='w-64 cursor-pointer rounded-lg object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>

      <div className='bottomImgHold flex flex-row relative gap-8'>
        <img src='https://c4.wallpaperflare.com/wallpaper/377/800/833/wedding-jewellery-traditional-ethnic-indian-bride-wallpaper-preview.jpg' className=' w-80 si cursor-pointer object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
        <img src='https://images.livemint.com/img/2023/03/04/1600x900/gold_jewel_1677948250353_1677948250553_1677948250553.jpg' className=' w-80 si cursor-pointer object-cover' id='mobileDontSHow' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>
