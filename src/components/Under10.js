        ...
        <div className='u20MainParent fof '>
            ...
            <div className='filterOptionsHold  relative'>
                {filter && <div className='flex rounded-xl gap-8 flex-col boxSh fof absolute '>
                    <p className='ml-12 scale cursor-pointer scale' onClick={bodyLotionHandler}> stone</p>
                    <p className='ml-12 scale cursor-pointer' onClick={bodyWashHandler}> traditional </p>
                    <p className='ml-12 scale cursor-pointer' onClick={bodyScrubHandler}> modern </p>
