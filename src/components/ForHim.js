...
const ForHim = () => {
    ...
    var bodyLotionProducts = store.filter(product => product.type.includes('stones'));

    var bodyScrubProducts = store.filter(produt => produt.type.includes("traditional"));

    var bodyWashProducts = store.filter(product => product.type.includes("modern"));
    ...
    return (
        <div className='u20MainParent fof '>
            ...
            <div className='u20HeadingHold gap-20 justify-center relative flex flex-col'>
                <p className='u20Heading'>Natural Gifts For Girls </p>
                <p className='u20Desc'>  collection of jewellery care gifts under $20.</p>
            </div>
            ...
            <div className='filterOptionsHold  relative'>
                {filter && <div className='flex rounded-xl gap-8 flex-col boxSh fof absolute '>
                    <p className='ml-12 scale cursor-pointer scale' onClick={bodyLotionHandler}> Rings</p>
                    <p className='ml-12 scale cursor-pointer' onClick={bodyWashHandler}> Stones </p>
                    <p className='ml-12 scale cursor-pointer' onClick={bodyScrubHandler}> Chains </p>
                    <p className='ml-12 scale cursor-pointer text-white' onClick={allShowHandler}> necklace </p>
